...
const createDomisili = (req, res) => {
  upload.single("ktp_image")(req, res, (err) => {
    ...
    // Generate nomor surat unik dengan panjang 5 karakter
    ...
    const sqlQuery = `
    INSERT INTO surat_ket_domisili
...
const getByNomorSurat = (req, res) => {
  ...
  const sqlQuery = `
    SELECT * FROM surat_ket_domisili
    WHERE nomor_surat = ?
  `;
...
const getDomisiliMenunggu = (req, res) => {
  ...
  const sqlQuery = `
    SELECT * FROM surat_ket_domisili where status_admin = 'menunggu'
  `;
...
const getDomisiliTerima = (req, res) => {
  ...
  const sqlQuery = `
    SELECT * FROM surat_ket_domisili where status_admin = 'diterima'
  `;
...
const deleteDomisili = (req, res) => {
  ...
  const sqlQuery = `
    DELETE FROM  surat_ket_domisili
    WHERE id = ?
  `;
