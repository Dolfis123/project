...
function TambahPegawai() {
  ...
  const handleSubmit = async (event) => {
    ...
    axios
      .post("http://localhost:3040/addpegawai", formData)
      .then((res) => {
        ...
        <div className="d-flex flex-column align-items-center pt-4 loginPage text-white">
          ...
          <form className="row g-3 w-50" onSubmit={handleSubmit}>
            <div className="col-12">
              <label form="inputNama" className="form-label text-white">
                Jabatang
              </label>
              <input
                type="text"
            ...
            <div className="col-12">
              <label form="inputEmail4" className="form-label text-white">
                Nama
              </label>
              <input
                type="text"
            ...
            <div className="col-12">
              <label form="inputPassword4" className="form-label text-white">
                NIP
              </label>
              <input
                type="text"
            ...
            <div className="col-12">
              <label form="inputAddress4" className="form-label text-white">
                Image
              </label>
              <input
                type="file"
