...
function SuratDomisili() {
  ...
  const [tempat_tanggal_lahir, setTampat_tanggal_lahir] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("tempat_tanggal_lahir", formattedDate);
      ...
      const response = await axios.post(
        "http://localhost:3040/buat-surat-skck",
        formData,
        {
          headers: {
        ...
        <div className="card">
          <div className="card-header text-center">
            <h2 style={{ color: "#3468C0" }}>
              FORM BIODATA DIRI KETERANGAN TIDAK MAMPU
            </h2>
          </div>
          <br />
