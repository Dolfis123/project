...
function SuratDomisiliArsip() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3040/lihat-surat-diterima-domisili"
      );
  ...
  const handleCetakClick = (skckId) => {
    ...
    window.location.href = `/format-surat-domisili/${skckId}`;
  };
...
export default SuratDomisiliArsip;
