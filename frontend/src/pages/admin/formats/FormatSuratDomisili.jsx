      ...
      <div className="kopsurat" id="my-content">
        ...
        >
          ...
          <div style={{ display: "flex", marginBottom: "5px" }}>
            ...
            <span className="test">
              : {data.tempat_lahir}, {formatDate(data.ttl)}
            </span>
          </div>
          <div style={{ display: "flex", marginBottom: "5px" }}>
            <span className="test" style={{ flex: "0 0 150px" }}>
            ...
            <span className="test">: {data.jk}</span>
          </div>
          <div style={{ display: "flex", marginBottom: "5px" }}>
            <span className="test" style={{ flex: "0 0 150px" }}>
              Agama{" "}
          ...
          <div style={{ display: "flex", marginBottom: "5px" }}>
            ...
            <span className="test">: {data.ktp}</span>
          </div>
        </div>
        <p
          style={{
        ...
        >
          ...
          di Kelurahan Amban Distrik Manokwari Barat,
        </p>
        ...
        <p className="test" style={{ marginBottom: "0" }}>
          Untuk Kepengurusan : <b> {data.keperluan}</b>
        </p>
        <p className="test" style={{ marginBottom: "0" }}>
          Demikian Surat Keterangan ini diberikan kepada yang bersangkutan agar
        </p>
        <p className="test"> dapat dipergunakan sebagaimana mestinya. </p>
        <p
          className="test"
          style={{
            marginTop: "40px",
...
export default FormatSuratDomisili;
